...
//         success_url: `http://localhost:5173/paymentsuccess/?amount=${encodeURIComponent(
//           totalAmount
//         )}&transaction_uuid=${encodeURIComponent(
//           prevData.transaction_uuid
//         )}&roomid=${encodeURIComponent(roomid)}&rent_id=${encodeURIComponent(
//           prevData.rent_id
//         )}&rent_from=${encodeURIComponent(
//           rentFrom
//         )}&rent_to=${encodeURIComponent(rentTo)}`,
//       }));
//     }
//   }, [dateDifference]);
...
const PlaceDetails = () => {
  ...
  const [esewaData, setEsewaData] = useState({
    ...
    tax_amount: "0",
    total_amount: "10",
    transaction_uuid: "uuid-placeholder", // Generate dynamically as needed
    product_service_charge: "0",
    product_delivery_charge: "0",
    product_code: "EPAYTEST",
    success_url: "",
  ...
  useEffect(() => {
    if (dateDifference > 0 && room) {
      ...
      setEsewaData((prevData) => ({
        ...
        total_amount: totalAmount,
        amount: totalAmount,
        success_url: `http://localhost:5173/paymentsuccess/?amount=${totalAmount}&transaction_uuid=${prevData.transaction_uuid}&roomid=${roomid}&rent_from=${rentFrom}&rent_to=${rentTo}`,
      }));
    }
  }, [dateDifference, room]);
